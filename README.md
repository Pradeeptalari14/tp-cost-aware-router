...
> Lightweight classifier routing queries to cheaper models based on semantic difficulty.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/cost-aware-router/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-cost-aware-router.git
cd tp-cost-aware-router
```
...
```bash
kubectl port-forward deployment/tp-cost-aware-router 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── cost_router.py     # Main configuration file
```
...
---
*Generated by [Cost-Aware Router Studio](https://pradeeptalari14.github.io/portfolio/tools/cost-aware-router/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
